window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function ExtensionsSection(props) {
      ...
      const loadWd = React.useCallback(() => {
        ...
        e('div', { className: 'smForm' },
          e('div', { className: 'smCardRow' },
            ...
            e('div', { className: 'smActions' },
              wd && wd.running
                ? e('button', { type: 'button', className: 'smBtn smBtnDanger', disabled: isBusy('wd:stop'), onClick: () => doWd('stop') }, t('wdStop'))
                : e('button', { type: 'button', className: 'smBtn smBtnPrimary', disabled: isBusy('wd:start'), onClick: () => doWd('start') }, t('wdStart')),
              e('button', { type: 'button', className: 'smBtn', disabled: isBusy('wd:start') || isBusy('wd:stop'), onClick: loadWd }, t('wdRefresh')),
            ),
          ),
        ),
